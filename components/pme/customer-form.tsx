...
import { addCustomerAction, type PmeActionState } from "@/app/actions/pme";
...
export function CustomerForm() {
  ...
  return (
    <form action={action} className="space-y-4 rounded-xl border bg-white p-6">
      <h3 className="font-semibold text-[#0B1D2A]">Nouveau client</h3>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          <Label htmlFor="is_recurring">Client récurrent</Label>
          <select id="is_recurring" name="is_recurring" className="flex h-10 w-full rounded-md border px-3 text-sm">
